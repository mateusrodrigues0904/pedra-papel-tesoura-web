    ...
    if (escJogador === "Pedra") {
        if (escMaquina === "Tesoura") {
            setTimeout(function () {
                ...
                perdeu.style.display = "none";
                empate.style.display = "none";
                escJogadorPedra.style.boxShadow = "inset 1px 5px 1px 1px rgba(0, 0, 0, 0.274), 1px 1px 40px rgba(255, 255, 255, 0.13), 1px 1px 1px 70px rgba(255, 255, 255, 0.05), 1px 1px 1px 100px rgba(255, 255, 255, 0.03)";
                pontuacao1 += 1;
            ...
            setTimeout(function () {
                ...
                empate.style.display = "none";
                maqPapel.style.boxShadow = "inset 1px 5px 1px 1px rgba(0, 0, 0, 0.274), 1px 1px 40px rgba(255, 255, 255, 0.13), 1px 1px 1px 70px rgba(255, 255, 255, 0.05), 1px 1px 1px 100px rgba(255, 255, 255, 0.03)";
                if(pontuacao1 > 0) {
                    pontuacao1 -= 1;
                    pontuacao.innerText = String(pontuacao1);
                }
            ...
            setTimeout(function () {
                ...
                maqPedra.style.boxShadow = "inset 1px 5px 1px 1px rgba(0, 0, 0, 0.274), 1px 1px 40px rgba(255, 255, 255, 0.13), 1px 1px 1px 70px rgba(255, 255, 255, 0.05), 1px 1px 1px 100px rgba(255, 255, 255, 0.03)";
                escJogadorPedra.style.boxShadow = "inset 1px 5px 1px 1px rgba(0, 0, 0, 0.274), 1px 1px 40px rgba(255, 255, 255, 0.13), 1px 1px 1px 70px rgba(255, 255, 255, 0.05), 1px 1px 1px 100px rgba(255, 255, 255, 0.03)";
        ...
        if (escMaquina === "Pedra") {
            setTimeout(function () {
                ...
                perdeu.style.display = "none";
                empate.style.display = "none";
                escJogadorPapel.style.boxShadow = "inset 1px 5px 1px 1px rgba(0, 0, 0, 0.274), 1px 1px 40px rgba(255, 255, 255, 0.13), 1px 1px 1px 70px rgba(255, 255, 255, 0.05), 1px 1px 1px 100px rgba(255, 255, 255, 0.03)";
                pontuacao1 += 1;
                pontuacao.innerText = String(pontuacao1);
            }, 1000);
            ...
            setTimeout(function () {
                ...
                perdeu.style.display = "block";
                empate.style.display = "none";
                maqTesoura.style.boxShadow = "inset 1px 5px 1px 1px rgba(0, 0, 0, 0.274), 1px 1px 40px rgba(255, 255, 255, 0.13), 1px 1px 1px 70px rgba(255, 255, 255, 0.05), 1px 1px 1px 100px rgba(255, 255, 255, 0.03)";
                if(pontuacao1 > 0) {
                    pontuacao1 -= 1;
                    pontuacao.innerText = String(pontuacao1);
                }
        ...
        if(escMaquina === "Papel"){
            setTimeout(function () {
                ...
                perdeu.style.display = "none";
                empate.style.display = "none";
                escJogadorTesoura.style.boxShadow = "inset 1px 5px 1px 1px rgba(0, 0, 0, 0.274), 1px 1px 40px rgba(255, 255, 255, 0.13), 1px 1px 1px 70px rgba(255, 255, 255, 0.05), 1px 1px 1px 100px rgba(255, 255, 255, 0.03)";
                pontuacao1 += 1;
                pontuacao.innerText = String(pontuacao1);
            }, 1000);
        } else if (escMaquina === "Pedra"){
